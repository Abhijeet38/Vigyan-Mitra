...
const learningContent: Record<number, { name: string; videoUrl: string }[]> = {
    6: [
        ...
        { name: "Atoms and Molecules", videoUrl: "https://www.youtube.com/embed/zf0_JPToEM0" },
        { name: "Metals and Non-metals", videoUrl: "https://scichamp.com/metals-and-non-metals-game/"},
        // Biology
        { name: "Digestive System", videoUrl: "https://scichamp.com/digestive-system-game/"},
        { name: "Photosynthesis and Plant Respiration", videoUrl: "https://scichamp.com/photosynthesis-and-plant-respiration-game/"},
        { name: "Excretory System", videoUrl: "https://scichamp.com/excretory-system-game"},
    ],
    7: [
        { name: "Metals and Non-metals", videoUrl: "https://scichamp.com/metals-and-non-metals-game/"},
        // Biology
    ...
    8: [
        { name: "Ions and Ionic Compounds", videoUrl: "https://scichamp.com/Chemistry%20games/ions%20and%20ionic%20compounds/"},
        { name: "Metals and Non-metals", videoUrl: "https://scichamp.com/metals-and-non-metals-game/"},
        // Biology
        { name: "Digestive System", videoUrl: "https://scichamp.com/digestive-system-game/"},
        { name: "Photosynthesis and Plant Respiration", videoUrl: "https://scichamp.com/photosynthesis-and-plant-respiration-game/"},
    ...
    !open ? null : (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm transition-all">
            <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-2xl w-full relative animate-fade-in">
                ...
                <div className="aspect-video rounded-lg overflow">{children}</div>
            </div>
        </div>
    );
                    ...
                    {expandedGame && (
                        <div className="rounded-2xl overflow-hidden shadow-lg border-4 border-yellow-200 bg-yellow-50 p-2 flex flex-col items-center w-full">
                            <iframe
                                ...
                                allowFullScreen
                                className="rounded-xl"
                                style={{ background: "#fef9c3", minHeight: 600, minWidth: 1800 }}
                            ></iframe>
                        </div>
                    )}
                </Modal>
